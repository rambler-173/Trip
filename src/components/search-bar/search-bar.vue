  ...
  <div class="search">
    <div class="select-time">
      <div class="item start">
        ...
        <div class="date">{{startDataStr}}</div>
      </div>
      <div class="item end">
        <div class="name">离</div>
        <div class="date">{{endDataStr}}</div>
      </div>
    </div>
    <div class="content">
...
const startDataStr = computed(() => formatMonthDay(startData.value, "MM.DD"))
const endDataStr = computed(() => formatMonthDay(endData.value, "MM.DD"))
